...
- (NSString *)ISO8601DateString {
  return [self ISO8601DateStringWithTime:NO timeSeparator:ISO8601UnparserDefaultTimeSeparatorCharacter];
}
- (NSString *)ISO8601WeekDateString {
  return [self ISO8601WeekDateStringWithTime:NO timeSeparator:ISO8601UnparserDefaultTimeSeparatorCharacter];
}
- (NSString *)ISO8601OrdinalDateString {
  return [self ISO8601OrdinalDateStringWithTime:NO timeSeparator:ISO8601UnparserDefaultTimeSeparatorCharacter];
}
